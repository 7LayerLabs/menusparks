        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {calculations.map((calc, index) => (
              <div key={index} className="bg-gray-900 rounded-xl p-8 border-2 border-gray-700 hover:border-green-500 transition-all duration-300 transform hover:scale-105">
          ...
          <div className="mt-12 bg-gray-900 rounded-xl p-6 border border-gray-700 text-center">
